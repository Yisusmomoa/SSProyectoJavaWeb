 ...
 * @author bjls2
 */
@WebServlet(name = "paginaPrincipalControllerMaestro", urlPatterns = {"/paginaPrincipalControllerMaestro"})
public class paginaPrincipalControllerMaestro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet paginaPrincipalControllerMaestro at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
