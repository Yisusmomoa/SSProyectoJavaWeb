 ...
 * @author bjls2
 */
@WebServlet(name = "FiltrarNombreMaestro", urlPatterns = {"/FiltrarNombreMaestro"})
public class FiltrarNombreMaestro extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet FiltrarNombreMaestro</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet FiltrarNombreMaestro at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        String FiltrarNombreMaestro=request.getParameter("search");
        List<Maestro> listaMaestros=new ArrayList<>();
        try {
            listaMaestros=maestroDAO.getBusquedaMaestro(FiltrarNombreMaestro);
            json.put("status", 200);
            String Tabla;
            Tabla="";
            ...
            Logger.getLogger(FiltrarNombreMaestro.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
