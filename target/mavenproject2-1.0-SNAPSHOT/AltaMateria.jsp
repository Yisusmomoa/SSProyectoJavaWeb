<%-- 
    ...
    Created on : 16 jun. 2022, 13:30:45
    Author     : bjls2
--%>
...
<html>
    ...
    navbar-dark bg-primary fixed-top ">
        <div class="container-fluid">
          ...
          <a class="navbar-brand" href="paginaPrincipalController">Inicio</a>
          <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link" href="./InscribirMateria.jsp">Inscribir materia</a>
              </li>
              <li class="nav-item">
    ...
    <h1 class="mt-5 pt-5 pb-2 text-center">Alta materia</h1>

    <div class="container ">
      <div class="row justify-content-center align-items-center vh-75 ">
       <div class="col-6 bg-light border border rounded">
           <form class="p-5" id="addMateria" >
              <div class="mb-3">
                  <label for="exampleInputEmail1" class="form-label">Nombre materia</label>
